...
export default function NewshopByWeight(){
    ...
    return(
        ...
        <p className="text-center text-5xl text-[#832729]">Shop By Weight</p>
                                    ...
                                    weight.map((c) => (
                                        ...
                                        <div className="mt-3 md:mt-0 md:col-span-1 shadow-2xl bg-[#f2e9e9]   h-[260px] max-  max-w-40 rounded hover:scale-105 hover:zIndex-5 duration-[400]">
                                            <div className="grid grid-row-10 ">
                                                <div className="row-span-9 rounded "><img src={Jw} className="rounded h-48" alt="" /></div>
    ...
    <div className="flex justify-center mb-8">
            <button className="border-2 animate-bounce flex   border-black bg-transparent p-2 rounded mt-5  hover:bg-[#832729]  hover:text-[#ffffff] hover:border-0 " >View All &nbsp; <MdKeyboardDoubleArrowRight className="text-3xl"/></button>
        </div>
    </Link>
